    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DeleteEntry.this, "Error Fetching Survey Names..", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        for (Map.Entry<String, Object> entry : Entries.entrySet())
        {
            ...
            b.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    AlertDialog alertDialog = new AlertDialog.Builder(DeleteEntry.this).create();
                    alertDialog.setTitle("Alert");
                    alertDialog.setCancelable(true);
                    alertDialog.setMessage("Do you wish to Delete the entry:\n" + b.getText().toString() +"?\n\nAll the data in this entry will be lost. \n");
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Yes",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    refdelete= rootnode.getReference("data").child(surveyname).child(uid).child(Name);
                                    refdelete.addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
                                        ...
                                        public void onCancelled(@NonNull DatabaseError databaseError) {
                                            Toast.makeText(DeleteEntry.this, "Action Failed", Toast.LENGTH_SHORT).show();
                                        }
